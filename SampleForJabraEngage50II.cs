...
internal class SampleForJabraEngage50II
{
    public static async void ReadWriteObserve(IDevice device, IPropertyFactory jabraSdkPropsFactory)
    {
        ...
        Console.WriteLine("Observing microphone mute state.");
        SampleHelpers.ObserveProperty(propertyMap, "microphoneMuteState"); // Observe the property for microphone mute state.
    }
}